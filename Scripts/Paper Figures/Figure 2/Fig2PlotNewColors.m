...
%% Text
mar=0.13; %margin
Layer14=text(figs(3,4),0,Y_size+mar,'N=14','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
Layer7=text(figs(3,3),0,Y_size+mar,'N=7','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
Layer5=text(figs(3,2),0,Y_size+mar,'N=6','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
Layer3=text(figs(3,1),0,Y_size+mar,'N=3','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
CrossSectionXaxis14=text(figs(1,4),mar*3.5,-mar*2.5,'x ({\mum})','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
CrossSectionXaxis7=text(figs(1,3),mar*3.5,-mar*2.5,'x ({\mum})','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
CrossSectionXaxis6=text(figs(1,2),mar*3.5,-mar*2.5,'x ({\mum})','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
CrossSectionXaxis3=text(figs(1,1),mar*3.5,-mar*2.5,'x ({\mum})','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
...
a=text(figs(3,1),mar,Y_size-mar,'a','Units','in','Color','w','FontSize',12,'FontName',FontName);
b=text(figs(3,2),mar,Y_size-mar,'b','Units','in','Color','w','FontSize',12,'FontName',FontName);
c=text(figs(3,3),mar,Y_size-mar,'c','Units','in','Color','w','FontSize',12,'FontName',FontName);
d=text(figs(3,4),mar,Y_size-mar,'d','Units','in','Color','w','FontSize',12,'FontName',FontName);
e=text(figs(2,1),mar,Y_size-mar,'e','Units','in','Color','w','FontSize',12,'FontName',FontName);
f=text(figs(2,2),mar,Y_size-mar,'f','Units','in','Color','w','FontSize',12,'FontName',FontName);
g=text(figs(2,3),mar,Y_size-mar,'g','Units','in','Color','w','FontSize',12,'FontName',FontName);
h=text(figs(2,4),mar,Y_size-mar,'h','Units','in','Color','w','FontSize',12,'FontName',FontName);
i=text(figs(1,1),mar,Y_size-mar,'i','Units','in','Color','k','FontSize',12,'FontName',FontName);
j=text(figs(1,2),mar,Y_size-mar,'j','Units','in','Color','k','FontSize',12,'FontName',FontName);
k=text(figs(1,3),mar,Y_size-mar,'k','Units','in','Color','k','FontSize',12,'FontName',FontName);
l=text(figs(1,4),mar,Y_size-mar,'l','Units','in','Color','k','FontSize',12,'FontName',FontName);

XLabelePanele=text(figs(2,1),0.43,0.13,'x','Units','in','Color','w','FontSize',12,'FontName',FontName);
YLabelePanele=text(figs(2,1),0.07,0.54,'y','Units','in','Color','w','FontSize',12,'FontName',FontName);

PearlLength14=text(figs(1,4),0.5*mar,1.5*mar,'{\Lambda}=12 {\mum}','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
PearlLength7=text(figs(1,3),0.5*mar,1.5*mar,'{\Lambda}=30 {\mum}','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
PearlLength6=text(figs(1,2),0.5*mar,1.5*mar,'{\Lambda}=101 {\mum}','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
PearlLength3=text(figs(1,1),0.5*mar,1.5*mar,'{\Lambda}=111 {\mum}','Units','in','Color',[0 0 0],'FontSize',12,'FontName',FontName);
%% loading data
