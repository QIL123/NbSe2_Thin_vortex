...
while er & D>0
try
X1=X1(ycut-D:ycut+D,xcut-D:xcut+D);
Y1=Y1(ycut-D:ycut+D,xcut-D:xcut+D);
...
%%
X_SingleVortexSim=X1;
Y_SingleVortexSim=X1;
M_SingleVortexSim=MTFDataDifferentiation1;
M_SingleVortexSimFit=ConvBzDataDifferentiation_diff1;

%save(['Paper Figures\Supplementary\Multy_Vortex_Sim\SingleVortexSimFit.mat'],'X_SingleVortexSim','Y_SingleVortexSim','M_SingleVortexSim','M_SingleVortexSimFit')
